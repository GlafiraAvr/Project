...
//   Admm.ShowModal;
  inherited;
  Enabled := false;
  _AvrAdminManager := TAvrAdminManager.Create('AVARODESSA', 'masterkey');
  try
...
begin
  ...
  old_SI_zak.Caption:=TrLangMSG(msgClosed)+' наряды';
  old_SI_zak.Hint:=TrLangMSG(msgClosed)+' наряды|';
  old_SI_nzak.Caption:=TrLangMSG(msgNotClosed)+' наряды';
  old_SI_nzak.Hint:=TrLangMSG(msgNotClosed)+' наряды|';
  ...
  SI_zak.Hint:=TrLangMSG(msgClosed)+' наряды';
  SI_nzak.Hint:=TrLangMSG(msgNotClosed)+' наряды';
  ...
  N23.Caption:=TrLangMSG(msgNotClosed)+' наряды';
  N24.Caption:=TrLangMSG(msgClosed)+' наряды';
