...
uses
  ...
  _avonm_DMAvarUnit in '_avonm_DMAvarUnit.pas',
  _avonm_DMSpisOfAvarUnit in '_avonm_DMSpisOfAvarUnit.pas',
...
<<<<<<< HEAD
  Application.CreateForm(Tdm_NGReportBase1, dm_NGReportBase1);
