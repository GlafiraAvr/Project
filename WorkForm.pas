...
uses
  ...
  Buttons, WorkContainerDM, MaterDM, BWorkDM, BaseWorkAndMatDM;
...
begin
  ...
  if Application.MessageBox( 'Вы уверены, что хотите удалить запись?', 'Внимание',
  ...
  begin
    ...
    begin
      ...
      begin
        if Application.MessageBox( PChar('При удалении данной работы будет удалена сооствествующая' + #13 +
          'раскопка, а также все соответствующие ей работы по благоустройству.' + #13 +
          'Продолжить?' ), 'Внимание', MB_YESNO + MB_ICONQUESTION ) = ID_YES
        then
        begin
