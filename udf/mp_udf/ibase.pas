(*
 *	MODULE:		ibase.pas
 *	DESCRIPTION:	Delphi port of Borland's Ibase.h for C
 *
...
type
  ...
  PISC_QUAD            = ^TISC_QUAD;
  (*$define  isc_quad_high       gds_quad_high*) // useless
  (*$define  isc_quad_low        gds_quad_low*)  // useless
...
(** I have left this example structure because of the  **)
(** docs on isc_start_transaction, but all examples    **)
(** point to the "correct?" ISC_TEB structure which is **)
(** documented in examples for isc_start_multiple      **)
(********************************************************)
...
function isc_blob_gen_bpb       (status_vector            : PISC_STATUS;
				 to_descriptor,
...
function isc_blob_lookup_desc   (status_vector            : PISC_STATUS;
                                 db_handle                : PISC_DB_HANDLE;
                                 trans_handle             : PISC_TR_HANDLE;
                                 table_name,
                                 column_name              : PChar;
...
function isc_blob_set_desc      (status_vector            : PISC_STATUS;
                                 table_name,
                                 column_name              : PChar;
                                 subtype,
                                 charset,
...
function isc_create_blob        (status_vector            : PISC_STATUS;
				 db_handle                : PISC_DB_HANDLE;
...
function isc_dsql_fetch2        (status_vector            : PISC_STATUS;
                                 stmt_handle              : PISC_STMT_HANDLE;
				 dialect                  : UShort;
				 xsqlda                   : PXSQLDA;
				 isc_arg5                 : UShort;
...
function isc_dsql_insert        (status_vector            : PISC_STATUS;
                                 stmt_handle              : PISC_STMT_HANDLE;
				 arg3                     : UShort;
				 xsqlda                   : PXSQLDA): ISC_STATUS;
                                stdcall; external IBASE_DLL;
...
function isc_dsql_sql_info      (status_vector             : PISC_STATUS;
                                 stmt_handle               : PISC_STMT_HANDLE;
				 item_length               : UShort; // doc says unsigned, header says signed?
                                 items                     : PChar;
                                 buffer_length             : UShort; // doc says unsigned, header says signed?
                                 buffer                    : PChar): ISC_STATUS;
                                stdcall; external IBASE_DLL;

procedure isc_encode_date       (tm_date                    : PCTimeStructure;
				 ib_date                    : PISC_QUAD);
                                stdcall; external IBASE_DLL;
...
procedure isc_expand_dpb        (dpb                       : PPChar;
				 dpb_length                : PShort;
				 item_list                 : array of Pointer);
                                cdecl; external IBASE_DLL;

function isc_modify_dpb         (dpb                       : PPChar;
				 isc_arg2,
                                 isc_arg3                  : PShort;
                                 isc_arg4                  : UShort;
				 isc_arg5                  : PChar;
...
function isc_get_slice          (status_vector             : PISC_STATUS;
                                 db_handle                 : PISC_DB_HANDLE;
                                 tran_handle               : PISC_TR_HANDLE;
                                 isc_arg4                  : PISC_QUAD;
                                 isc_arg5                  : Short;
...
function isc_interprete         (buffer                    : PChar;
				 status_vector             : PPISC_STATUS): ISC_STATUS;
                                stdcall; external IBASE_DLL;

function isc_open_blob          (status_vector             : PISC_STATUS;
                                 db_handle                 : PISC_DB_HANDLE;
                                 tran_handle               : PISC_TR_HANDLE;
				 blob_handle               : PISC_BLOB_HANDLE;
				 blob_id                   : PISC_QUAD): ISC_STATUS;
...
function isc_prepare_transaction2(status_vector            : PISC_STATUS;
                                 tran_handle               : PISC_TR_HANDLE;
                                 msg_length                : Short;
...
function isc_put_slice          (status_vector             : PISC_STATUS;
                                 db_handle                 : PISC_DB_HANDLE;
                                 tran_handle               : PISC_TR_HANDLE;
				 isc_arg4                  : PISC_QUAD;
				 isc_arg5                  : Short;
...
function isc_transact_request   (status_vector             : PISC_STATUS;
                                 db_handle                 : PISC_DB_HANDLE;
                                 tran_handle               : PISC_TR_HANDLE;
				 isc_arg4                  : UShort;
                                 isc_arg5                  : PChar;
...
function isc_vax_integer        (buffer                    : PChar;
...
function isc_add_user           (status_vector             : PISC_STATUS;
                                 user_sec_data             : PUserSecData): ISC_STATUS;
                                stdcall; external IBASE_DLL;

function isc_delete_user        (status_vector             : PISC_STATUS;
                                 user_sec_data             : PUserSecData): ISC_STATUS;
                                stdcall; external IBASE_DLL;

function isc_modify_user        (status_vector             : PISC_STATUS;
                                 user_sec_data             : PUserSecData): ISC_STATUS;
                                stdcall; external IBASE_DLL;
...
function isc_compile_request    (status_vector             : PISC_STATUS;
                                 db_handle                 : PISC_DB_HANDLE;
...
function isc_compile_request2   (status_vector             : PISC_STATUS;
                                 db_handle                 : PISC_DB_HANDLE;
                                 request_handle            : PISC_REQ_HANDLE;
				 isc_arg4                  : Short;
				 isc_arg5                  : PChar): ISC_STATUS;
...
function isc_ddl                (status_vector             : PISC_STATUS;
			         db_handle                 : PISC_DB_HANDLE;
			         tran_handle               : PISC_TR_HANDLE;
			         isc_arg4                  : Short;
			         isc_arg5                  : PChar): ISC_STATUS;
...
function isc_receive            (status_vector             : PISC_STATUS;
                                 request_handle            : PISC_REQ_HANDLE;
				 isc_arg3,
                                 isc_arg4                  : Short;
				 isc_arg5                  : PVoid;
...
function isc_receive2           (status_vector             : PISC_STATUS;
                                 request_handle            : PISC_REQ_HANDLE;
				 isc_arg3,
                                 isc_arg4                  : Short;
				 isc_arg5                  : PVoid;
...
function isc_reconnect_transaction(status_vector             : PISC_STATUS;
                                 db_handle                 : PISC_DB_HANDLE;
                                 tran_handle               : PISC_TR_HANDLE;
                                 isc_arg4                  : Short;
                                 isc_arg5                  : PChar): ISC_STATUS;
...
function isc_release_request    (status_vector             : PISC_STATUS;
                                 request_handle            : PISC_REQ_HANDLE): ISC_STATUS;
                                stdcall; external IBASE_DLL;

function isc_request_info       (status_vector             : PISC_STATUS;
                                 request_handle            : PISC_REQ_HANDLE;
                                 isc_arg3                  : Short;
                                 isc_arg4                  : Short;
                                 isc_arg5                  : PChar;
...
function isc_seek_blob          (status_vector             : PISC_STATUS;
                                 blob_handle               : PISC_BLOB_HANDLE;
                                 isc_arg3                  : Short;
                                 isc_arg4                  : ISC_LONG;
...
function isc_send               (status_vector             : PISC_STATUS;
				 request_handle            : PISC_REQ_HANDLE;
				 isc_arg3,
                                 isc_arg4                  : Short;
				 isc_arg5                  : PVoid;
...
function isc_start_and_send     (status_vector             : PISC_STATUS;
                                 request_handle            : PISC_REQ_HANDLE;
				 tran_handle               : PISC_TR_HANDLE;
				 isc_arg4,
                                 isc_arg5                  : Short;
...
function isc_start_request      (status_vector             : PISC_STATUS;
                                 request_handle            : PISC_REQ_HANDLE;
                                 tran_handle               : PISC_TR_HANDLE;
                                 isc_arg4                  : Short): ISC_STATUS;
                                stdcall; external IBASE_DLL;

function isc_unwind_request     (status_vector             : PISC_STATUS;
                                 tran_handle               : PISC_TR_HANDLE;
...
function isc_close              (status_vector             : PISC_STATUS;
                                 isc_arg2                  : PChar): ISC_STATUS;
                                stdcall; external IBASE_DLL;

function isc_declare            (status_vector             : PISC_STATUS;
                                 isc_arg2,
                                 isc_arg3                  : PChar): ISC_STATUS;
                                stdcall; external IBASE_DLL;

function isc_describe           (status_vector             : PISC_STATUS;
                                 isc_arg2                  : PChar;
                                 isc_arg3                  : PSQLDA): ISC_STATUS;
                                stdcall; external IBASE_DLL;

function isc_describe_bind      (status_vector             : PISC_STATUS;
                                 isc_arg2                  : PChar;
                                 isc_arg3                  : PSQLDA): ISC_STATUS;
                                stdcall; external IBASE_DLL;

function isc_execute            (status_vector             : PISC_STATUS;
                                 tran_handle               : PISC_TR_HANDLE;
                                 isc_arg3                  : PChar;
                                 isc_arg4                  : PSQLDA): ISC_STATUS;
                                stdcall; external IBASE_DLL;

function isc_execute_immediate  (status_vector             : PISC_STATUS;
                                 db_handle                 : PISC_DB_HANDLE;
                                 tran_handle               : PISC_TR_HANDLE;
                                 isc_arg4                  : PShort;
                                 isc_arg5                  : PChar): ISC_STATUS;
...
function isc_fetch              (status_vector             : PISC_STATUS;
				 isc_arg2                  : PChar;
				 isc_arg3                  : PSQLDA): ISC_STATUS;
                                stdcall; external IBASE_DLL;

function isc_open               (status_vector             : PISC_STATUS;
				 tran_handle               : PISC_TR_HANDLE;
				 isc_arg3                  : PChar;
				 isc_arg4                  : PSQLDA): ISC_STATUS;
                                stdcall; external IBASE_DLL;

function isc_prepare            (status_vector             : PISC_STATUS;
                                 db_handle                 : PISC_DB_HANDLE;
                                 tran_handle               : PISC_TR_HANDLE;
                                 isc_arg4                  : PChar;
                                 isc_arg5                  : PShort;
...
function isc_dsql_execute_m     (status_vector             : PISC_STATUS;
                                 tran_handle               : PISC_TR_HANDLE;
...
function isc_dsql_execute2_m    (status_vector             : PISC_STATUS;
                                 tran_handle               : PISC_TR_HANDLE;
                                 statement_handle          : PISC_STMT_HANDLE;
                                 isc_arg4                  : UShort;
                                 isc_arg5                  : PChar;
...
function isc_dsql_execute_immediate_m(status_vector        : PISC_STATUS;
                                 db_handle                 : PISC_DB_HANDLE;
                                 tran_handle               : PISC_TR_HANDLE;
                                 isc_arg4                  : UShort;
                                 isc_arg5                  : PChar;
...
function isc_dsql_exec_immed3_m (status_vector             : PISC_STATUS;
                                 db_handle                 : PISC_DB_HANDLE;
                                 tran_handle               : PISC_TR_HANDLE;
                                 isc_arg4                  : UShort;
                                 isc_arg5                  : PChar;
...
function isc_dsql_fetch_m       (status_vector             : PISC_STATUS;
                                 statement_handle          : PISC_STMT_HANDLE;
                                 isc_arg3                  : UShort;
                                 isc_arg4                  : PChar;
                                 isc_arg5                  : UShort;
...
(*$ifdef SCROLLABLE_CURSORS*)
function isc_dsql_fetch2_m      (status_vector             : PISC_STATUS;
                                 statement_handle          : PISC_STMT_HANDLE;
                                 isc_arg3                  : UShort;
                                 isc_arg4                  : PChar;
                                 isc_arg5                  : UShort;
...
function isc_dsql_insert_m      (status_vector             : PISC_STATUS;
                                 statement_handle          : PISC_STMT_HANDLE;
                                 isc_arg3                  : UShort;
                                 isc_arg4                  : PChar;
                                 isc_arg5                  : UShort;
...
function isc_dsql_prepare_m     (status_vector             : PISC_STATUS;
                                 tran_handle               : PISC_TR_HANDLE;
                                 statement_handle          : PISC_STMT_HANDLE;
                                 isc_arg4                  : UShort;
                                 isc_arg5                  : PChar;
...
function isc_dsql_release       (status_vector             : PISC_STATUS;
                                 isc_arg2                  : PChar): ISC_STATUS;
                                stdcall; external IBASE_DLL;

function isc_embed_dsql_close   (status_vector             : PISC_STATUS;
                                 isc_arg2                  : PChar): ISC_STATUS;
                                stdcall; external IBASE_DLL;

function isc_embed_dsql_declare (status_vector             : PISC_STATUS;
                                 isc_arg2                  : PChar;
                                 isc_arg3                  : PChar): ISC_STATUS;
                                stdcall; external IBASE_DLL;

function isc_embed_dsql_describe(status_vector             : PISC_STATUS;
                                 isc_arg2                  : PChar;
                                 isc_arg3                  : UShort;
                                 isc_arg4                  : PXSQLDA): ISC_STATUS;
                                stdcall; external IBASE_DLL;

function isc_embed_dsql_describe_bind(status_vector             : PISC_STATUS;
				 isc_arg2                  : PChar;
                                 isc_arg3                  : UShort;
                                 isc_arg4                  : PXSQLDA): ISC_STATUS;
                                stdcall; external IBASE_DLL;

function isc_embed_dsql_execute (status_vector             : PISC_STATUS;
                                 tran_handle               : PISC_TR_HANDLE;
                                 isc_arg3                  : PChar;
                                 isc_arg4                  : UShort;
...
function isc_embed_dsql_execute2(status_vector             : PISC_STATUS;
				 tran_handle               : PISC_TR_HANDLE;
                                 isc_arg3                  : PChar;
                                 isc_arg4                  : UShort;
                                 isc_arg5                  : PXSQLDA;
...
function isc_embed_dsql_execute_immed(status_vector        : PISC_STATUS;
				 db_handle                 : PISC_DB_HANDLE;
                                 tran_handle               : PISC_TR_HANDLE;
                                 isc_arg4                  : UShort;
                                 isc_arg5                  : PChar;
...
function isc_embed_dsql_fetch   (status_vector             : PISC_STATUS;
                                 isc_arg2                  : PChar;
                                 isc_arg3                  : UShort;
                                 isc_arg4                  : PXSQLDA): ISC_STATUS;
                                stdcall; external IBASE_DLL;
...
(*$ifdef SCROLLABLE_CURSORS*)
function isc_embed_dsql_fetch2 (status_vector             : PISC_STATUS;
                                isc_arg2                  : PChar;
                                isc_arg3                  : UShort;
                                isc_arg4                  : PXSQLDA;
                                isc_arg5                  : UShort;
...
function isc_embed_dsql_open    (status_vector             : PISC_STATUS;
                                 tran_handle               : PISC_TR_HANDLE;
                                 isc_arg3                  : PChar;
                                 isc_arg4                  : UShort;
                                 isc_arg5                  : PXSQLDA): ISC_STATUS;
...
function isc_embed_dsql_open2   (status_vector             : PISC_STATUS;
                                 tran_handle               : PISC_TR_HANDLE;
                                 isc_arg3                  : PChar;
                                 isc_arg4                  : UShort;
                                 isc_arg5                  : PXSQLDA;
...
function isc_embed_dsql_insert  (status_vector             : PISC_STATUS;
                                 isc_arg2                  : PChar;
                                 isc_arg3                  : UShort;
                                 isc_arg4                  : PXSQLDA): ISC_STATUS;
                                stdcall; external IBASE_DLL;

function isc_embed_dsql_prepare (status_vector             : PISC_STATUS;
                                 db_handle                 : PISC_DB_HANDLE;
                                 tran_handle               : PISC_TR_HANDLE;
                                 isc_arg4                  : PChar;
                                 isc_arg5                  : UShort;
...
function isc_embed_dsql_release (status_vector             : PISC_STATUS;
                                 isc_arg2                  : PChar): ISC_STATUS;
                                stdcall; external IBASE_DLL;
...
(** getb, putb, putbx are all defined in C as macros. We pascal folk must
   use functions and procedures to do our dirty work.... **)
...
function BLOB_close             (isc_arg1                  : PBSTREAM): Int;
                                stdcall; external IBASE_DLL;

function BLOB_get               (isc_arg1                  : PBSTREAM): Int;
                                stdcall; external IBASE_DLL;

function BLOB_display           (isc_arg1                  : PISC_QUAD;
                                 db_handle                 : TISC_DB_HANDLE;
                                 tran_handle               : TISC_TR_HANDLE;
                                 isc_arg4                  : PChar): Int;
                                stdcall; external IBASE_DLL;

function BLOB_dump              (isc_arg1                  : PISC_QUAD;
				 db_handle                 : TISC_DB_HANDLE;
				 tran_handle               : TISC_TR_HANDLE;
                                 isc_arg4                  : PChar): Int;
                                stdcall; external IBASE_DLL;

function BLOB_edit              (isc_arg1                  : PISC_QUAD;
				 db_handle                 : TISC_DB_HANDLE;
				 tran_handle               : TISC_TR_HANDLE;
                                 isc_arg4                  : PChar): Int;
                                stdcall; external IBASE_DLL;

function BLOB_load              (isc_arg1                  : PISC_QUAD;
				 db_handle                 : TISC_DB_HANDLE;
				 tran_handle               : TISC_TR_HANDLE;
                                 isc_arg4                  : PChar): Int;
                                stdcall; external IBASE_DLL;

function BLOB_text_dump         (isc_arg1                  : PISC_QUAD;
				 db_handle                 : TISC_DB_HANDLE;
				 tran_handle               : TISC_TR_HANDLE;
                                 isc_arg4                  : PChar): Int;
                                stdcall; external IBASE_DLL;

function BLOB_text_load         (isc_arg1                  : PISC_QUAD;
				 db_handle                 : TISC_DB_HANDLE;
				 tran_handle               : TISC_TR_HANDLE;
                                 isc_arg4                  : PChar): Int;
                                stdcall; external IBASE_DLL;

function Bopen                  (isc_arg1                  : PISC_QUAD;
				 db_handle                 : TISC_DB_HANDLE;
				 tran_handle               : TISC_TR_HANDLE;
                                 isc_arg4                  : PChar): Int;
                                stdcall; external IBASE_DLL;

function Bopen2                 (isc_arg1                  : PISC_QUAD;
				 db_handle                 : TISC_DB_HANDLE;
				 tran_handle               : TISC_TR_HANDLE;
                                 isc_arg4                  : PChar;
...
function isc_ftof               (isc_arg1                  : PChar;
				 isc_arg2                  : UShort;
				 isc_arg3                  : PChar;
				 isc_arg4                  : UShort): ISC_LONG;
                                stdcall; external IBASE_DLL;

function isc_print_blr          (isc_arg1                  : PChar;
                                 isc_arg2                  : TISC_CALLBACK;
                                 isc_arg3                  : PVoid;
                                 isc_arg4                  : Short): ISC_STATUS;
                                stdcall; external IBASE_DLL;

procedure isc_set_debug         (isc_arg1                  : Int);
                                stdcall; external IBASE_DLL;

procedure isc_qtoq              (isc_arg1                  : PISC_QUAD;
				 isc_arg2                  : PISC_QUAD);
                                stdcall; external IBASE_DLL;

procedure isc_vtof              (isc_arg1                  : PChar;
				 isc_arg2                  : PChar;
				 isc_arg3                  : UShort);
                                stdcall; external IBASE_DLL;

procedure isc_vtov              (isc_arg1                  : PChar;
				 isc_arg2                  : PChar;
				 isc_arg3                  : Short);
                                stdcall; external IBASE_DLL;

function isc_version            (db_handle                 : PISC_DB_HANDLE;
                                 isc_arg2                  : TISC_CALLBACK;
                                 isc_arg3                  : PVoid): Int;
                                stdcall; external IBASE_DLL;

function isc_reset_fpe          (isc_arg1                  : UShort): ISC_LONG;
                                stdcall; external IBASE_DLL;
...
function isc_attach_service     (status_vector             : PISC_STATUS;
                                 isc_arg2                  : UShort;
                                 isc_arg3                  : PChar;
...
function isc_detach_service     (status_vector             : PISC_STATUS;
                                 service_handle            : PISC_SVC_HANDLE): ISC_STATUS;
                                stdcall; external IBASE_DLL;

function isc_query_service      (status_vector             : PISC_STATUS;
                                 service_handle            : PISC_SVC_HANDLE;
                                 isc_arg3                  : UShort;
                                 isc_arg4                  : PChar;
                                 isc_arg5                  : UShort;
...
function isc_compile_map        (status_vector             : PISC_STATUS;
...
function isc_compile_menu       (status_vector             : PISC_STATUS;
                                 form_handle               : PISC_FORM_HANDLE;
                                 request_handle            : PISC_REQ_HANDLE;
                                 isc_arg4                  : PShort;
                                 isc_arg5                  : PChar): ISC_STATUS;
...
function isc_compile_sub_map    (status_vector             : PISC_STATUS;
...
function isc_create_window      (status_vector             : PISC_STATUS;
                                 win_handle                : PISC_WIN_HANDLE;
                                 isc_arg3                  : PShort;
                                 isc_arg4                  : PChar;
                                 isc_arg5                  : PShort;
...
function isc_delete_window      (status_vector             : PISC_STATUS;
                                 win_handle                : PISC_WIN_HANDLE): ISC_STATUS;
                                stdcall; external IBASE_DLL;

function isc_drive_form         (status_vector             : PISC_STATUS;
                                 db_handle                 : PISC_DB_HANDLE;
                                 tran_handle               : PISC_TR_HANDLE;
                                 win_handle                : PISC_WIN_HANDLE;
                                 request_handle            : PISC_REQ_HANDLE;
...
function isc_drive_menu         (status_vector             : PISC_STATUS;
                                 win_handle                : PISC_WIN_HANDLE;
                                 request_handle            : PISC_REQ_HANDLE;
                                 isc_arg4                  : PShort;
                                 isc_arg5                  : PChar;
...
function isc_form_delete        (status_vector             : PISC_STATUS;
                                 form_handle               : PISC_FORM_HANDLE): ISC_STATUS;
                                stdcall; external IBASE_DLL;

function isc_form_fetch         (status_vector             : PISC_STATUS;
                                 db_handle                 : PISC_DB_HANDLE;
                                 tran_handle               : PISC_TR_HANDLE;
                                 request_handle            : PISC_REQ_HANDLE;
...
function isc_form_insert        (status_vector             : PISC_STATUS;
                                 db_handle                 : PISC_DB_HANDLE;
                                 tran_handle               : PISC_TR_HANDLE;
                                 request_handle            : PISC_REQ_HANDLE;
                                 isc_arg5                  : PUChar): ISC_STATUS;
...
function isc_get_entree         (status_vector             : PISC_STATUS;
                                 request_handle            : PISC_REQ_HANDLE;
                                 isc_arg3                  : PShort;
                                 isc_arg4                  : PChar;
                                 isc_arg5                  : PISC_LONG;
...
function isc_initialize_menu    (status_vector             : PISC_STATUS;
                                 request_handle            : PISC_REQ_HANDLE): ISC_STATUS;
                                stdcall; external IBASE_DLL;

function isc_menu               (status_vector             : PISC_STATUS;
				 win_handle                : PISC_WIN_HANDLE;
				 request_handle            : PISC_REQ_HANDLE;
			 	 isc_arg4                  : PShort;
				 isc_arg5                  : PChar): ISC_STATUS;
...
function isc_load_form          (status_vector             : PISC_STATUS;
                                 db_handle                 : PISC_DB_HANDLE;
                                 tran_handle               : PISC_TR_HANDLE;
                                 form_handle               : PISC_FORM_HANDLE;
                                 isc_arg5                  : PShort;
...
function isc_pop_window         (status_vector             : PISC_STATUS;
                                 win_handle                : PISC_WIN_HANDLE): ISC_STATUS;
                                stdcall; external IBASE_DLL;

function isc_put_entree         (status_vector             : PISC_STATUS;
                                 request_handle            : PISC_REQ_HANDLE;
                                 isc_arg3                  : PShort;
                                 isc_arg4                  : PChar;
                                 isc_arg5                  : PISC_LONG): ISC_STATUS;
...
function isc_reset_form         (status_vector             : PISC_STATUS;
                                 request_handle            : PISC_REQ_HANDLE): ISC_STATUS;
                                stdcall; external IBASE_DLL;

function isc_suspend_window     (status_vector             : PISC_STATUS;
                                 win_handle                : PISC_WIN_HANDLE): ISC_STATUS;
                                stdcall; external IBASE_DLL;
