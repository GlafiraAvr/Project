...
uses HelpFunctions, GridViewBuilder, ServiceFuncUnit;
...
begin
  ...
  try
    ...
    try
      AddColToGVB( _gvb, 'dt_out', 'Окончание работ', alCenter );
      AddColToGVB( _gvb, 'brig_name', 'Бригадир', alLeft );
      AddColToGVB( _gvb, 'place_name', 'Место повреждения', alLeft );
      AddColToGVB( _gvb, 'clc_WORK_NAME', 'Работа', alLeft );
